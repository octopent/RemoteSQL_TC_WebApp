node{
   ...
   /*stage('SonarQube Server') {
    ...
    def server = Artifactory.server 'jenkins_artifactory'
     ...
     "files": [
           {
              "pattern": "/var/lib/jenkins/workspace/SqlTcPipeline/target/*.war",
	...
	stage('downloading artifact')
    {
        ...
        "files":[
        {
           "pattern":"mayank-snapshot/zzzzz-0.0.1-SNAPSHOT.war",
    ...
    stage ('Final deploy'){
        sh 'scp /var/lib/jenkins/warFiles/zzzzz-0.0.1-SNAPSHOT.war minduser@deployment-vm.eastus.cloudapp.azure.com:/opt/apache-tomcat-8.5.37/webapps'
    }
